...
class AttendanceSheet(object):
    ...
    def __init__(self, attendanceDictionary, studentList):
...
if __name__ == "__main__":
    ...
    main = AttendanceSheet(ad, [Student('', 1, 'Tyler Meeks', 'jtm0036@uah.edu'), Student('', 2, 'Samantha Boggs', 'sjb0034@uah.edu')])
    sys.exit(app.exec_())
