...
class StudentList:
    ...
    def __init__(self, courseUUID):
        ...
        cursor.execute(
            "CREATE TABLE IF NOT EXISTS `" + self.tableName + "` (`uuid`	TEXT,`ID`	TEXT,`name`	TEXT,`email`	TEXT);")
        connection.commit()
        self.load_students()
    ...
    def add_student(self, id, name, email):
        ...
        connection.execute(("INSERT INTO '" + str(self.tableName) + "' VALUES('" + str(newStudent.uuid) + "','" + str(
            newStudent.id) + "', '" + str(newStudent.name) + "', '" + str(newStudent.email) + "')"))
        connection.commit()
...
class Student:
    ...
    def set_email(self, email):
        self.email = email
        query = "UPDATE " + self.tableName + " SET email = '" + str(self.email) + "' WHERE uuid = '" + str(
            self.uuid) + "';"
        print(query)
    ...
    def set_name(self, name):
        ...
        query = "UPDATE " + self.tableName + " SET name = '" + str(self.name) + "' WHERE uuid = '" + str(
            self.uuid) + "';"
        print(query)
        cursor.execute(query)
        connection.commit()
    ...
    def save_student(self):
        ...
        connection.execute(
            "INSERT INTO " + str(self.tableName) + " VALUES(" + str(self.id) + ", '" + str(self.name) + "', '" + str(
                self.email) + "')")
        connection.commit()
