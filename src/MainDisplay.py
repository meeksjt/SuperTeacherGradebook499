...
if __name__ == "__main__":
   ...
   #course_uuid = main_display.course_manager.add_course(Course("Senior Project", "CS 499", "01", "Spring 18", "COURSE TEST3"))
   main_display.course_manager.set_current_course("COURSE TEST3")
