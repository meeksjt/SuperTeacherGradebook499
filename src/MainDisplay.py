...
if __name__ == "__main__":
   ...
   course = Course("Senior Project", "CS 499", "01", "Spring 18", "COURSE TEST")
   student = Student("1", "42", "Tyler Bomb", "skdfjkdsj@gmail.com")
   student2 = Student("2", "42", "Tyler Bombe", "skdfjkdsj@gmail.com")
   student3 = Student("3", "42", "Tyler Bombjk", "skdfjkdsj@gmail.com")
   main_display.course_manager.add_course(course)
   main_display.course_manager.set_current_course(course.course_uuid)
   ...
   main_display.course_data.add_course(course.course_name, course.course_uuid)
